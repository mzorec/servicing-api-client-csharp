...
namespace LoanStreet.LoanServicing.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PasswordAuthRequest :  IEquatable<PasswordAuthRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PasswordAuthRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PasswordAuthRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PasswordAuthRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PasswordAuthRequest {\n");
        ...
        {
            return this.Equals(input as PasswordAuthRequest);
        }

        /// <summary>
        /// Returns true if PasswordAuthRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PasswordAuthRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PasswordAuthRequest input)
        {
            if (input == null)
                return false;

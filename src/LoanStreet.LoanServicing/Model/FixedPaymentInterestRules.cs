...
namespace LoanStreet.LoanServicing.Model
{
    ...
    public partial class FixedPaymentInterestRules : InterestRules,  IEquatable<FixedPaymentInterestRules>, IValidatableObject
    {
        ...
        protected FixedPaymentInterestRules() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FixedPaymentInterestRules" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FixedPaymentInterestRules {\n");
        ...
        {
            return this.Equals(input as FixedPaymentInterestRules);
        }

        /// <summary>
        /// Returns true if FixedPaymentInterestRules instances are equal
        /// </summary>
        /// <param name="input">Instance of FixedPaymentInterestRules to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FixedPaymentInterestRules input)
        {
            if (input == null)
                return false;

...
{
    /// <summary>
    /// FloatingInterestTermsAllOf
    /// </summary>
    [DataContract]
    public partial class FloatingInterestTermsAllOf :  IEquatable<FloatingInterestTermsAllOf>, IValidatableObject
    {
        /// <summary>
        /// Defines Benchmark
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FloatingInterestTermsAllOf" /> class.
        /// </summary>
        /// <param name="benchmark">benchmark.</param>
        public FloatingInterestTermsAllOf(BenchmarkEnum? benchmark = default(BenchmarkEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FloatingInterestTermsAllOf {\n");
        ...
        {
            return this.Equals(input as FloatingInterestTermsAllOf);
        }

        /// <summary>
        /// Returns true if FloatingInterestTermsAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of FloatingInterestTermsAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FloatingInterestTermsAllOf input)
        {
            if (input == null)
                return false;

...
namespace LoanStreet.LoanServicing.Model
{
    ...
    public partial class PrincipalCharge : Charge,  IEquatable<PrincipalCharge>, IValidatableObject
    {
        ...
        public PrincipalCharge(string chargeId = default(string), Money amount = default(Money), LocalDatePeriod period = default(LocalDatePeriod), string type = default(string)) : base(chargeId, amount, period, type)
        {
        }

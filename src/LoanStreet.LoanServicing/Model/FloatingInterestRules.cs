...
{
    /// <summary>
    /// FloatingInterestRules
    /// </summary>
    [DataContract]
    public partial class FloatingInterestRules : InterestRules,  IEquatable<FloatingInterestRules>, IValidatableObject
    {
        /// <summary>
        /// Defines Benchmarks
        /// </summary>
        ...
        protected FloatingInterestRules() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FloatingInterestRules" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FloatingInterestRules {\n");
        ...
        {
            return this.Equals(input as FloatingInterestRules);
        }

        /// <summary>
        /// Returns true if FloatingInterestRules instances are equal
        /// </summary>
        /// <param name="input">Instance of FloatingInterestRules to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FloatingInterestRules input)
        {
            if (input == null)
                return false;

...
namespace LoanStreet.LoanServicing.Api
{
    ...
    public partial class FinanceApi : IFinanceApi
    {
        ...
        /// <returns></returns>
        public FinanceApi(LoanStreet.LoanServicing.Client.Configuration configuration)
        {
        ...
        public FinanceApi(LoanStreet.LoanServicing.Client.ISynchronousClient client,LoanStreet.LoanServicing.Client.IAsynchronousClient asyncClient, LoanStreet.LoanServicing.Client.IReadableConfiguration configuration)
        {

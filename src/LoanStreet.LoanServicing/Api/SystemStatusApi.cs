...
namespace LoanStreet.LoanServicing.Api
{
    ...
    public partial class SystemStatusApi : ISystemStatusApi
    {
        ...
        /// <returns></returns>
        public SystemStatusApi(LoanStreet.LoanServicing.Client.Configuration configuration)
        {
        ...
        public SystemStatusApi(LoanStreet.LoanServicing.Client.ISynchronousClient client,LoanStreet.LoanServicing.Client.IAsynchronousClient asyncClient, LoanStreet.LoanServicing.Client.IReadableConfiguration configuration)
        {

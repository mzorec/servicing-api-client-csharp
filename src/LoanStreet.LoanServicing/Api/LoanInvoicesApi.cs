...
namespace LoanStreet.LoanServicing.Api
{
    ...
    /// </summary>
    public interface ILoanInvoicesApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ILoanInvoicesApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ILoanInvoicesApi : ILoanInvoicesApiSync, ILoanInvoicesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class LoanInvoicesApi : ILoanInvoicesApi
    {
        private LoanStreet.LoanServicing.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="LoanInvoicesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public LoanInvoicesApi() : this((string) null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public LoanInvoicesApi(String basePath)
        {
        ...
        /// <returns></returns>
        public LoanInvoicesApi(LoanStreet.LoanServicing.Client.Configuration configuration)
        {
        ...
        public LoanInvoicesApi(LoanStreet.LoanServicing.Client.ISynchronousClient client,LoanStreet.LoanServicing.Client.IAsynchronousClient asyncClient, LoanStreet.LoanServicing.Client.IReadableConfiguration configuration)
        {
        ...
        public LoanStreet.LoanServicing.Client.ApiResponse< Invoice > CreateInvoiceWithHttpInfo (string loanId, Invoice invoice = default(Invoice))
        {
            ...
            if (loanId == null)
                throw new LoanStreet.LoanServicing.Client.ApiException(400, "Missing required parameter 'loanId' when calling LoanInvoicesApi->CreateInvoice");
        ...
        public LoanStreet.LoanServicing.Client.ApiResponse< Invoice > GetInvoiceWithHttpInfo (string loanId, string invoiceId)
        {
            // verify the required parameter 'loanId' is set
            if (loanId == null)
                throw new LoanStreet.LoanServicing.Client.ApiException(400, "Missing required parameter 'loanId' when calling LoanInvoicesApi->GetInvoice");

            // verify the required parameter 'invoiceId' is set
            if (invoiceId == null)
                throw new LoanStreet.LoanServicing.Client.ApiException(400, "Missing required parameter 'invoiceId' when calling LoanInvoicesApi->GetInvoice");
        ...
        public LoanStreet.LoanServicing.Client.ApiResponse< List<Invoice> > ListInvoiceHistoryWithHttpInfo (string loanId)
        {
            // verify the required parameter 'loanId' is set
            if (loanId == null)
                throw new LoanStreet.LoanServicing.Client.ApiException(400, "Missing required parameter 'loanId' when calling LoanInvoicesApi->ListInvoiceHistory");

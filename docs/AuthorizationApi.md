...
[**AuthInstitution**](AuthorizationApi.md#authinstitution) | **GET** /v1/public/auth/inst | 
...
namespace Example
{
    public class AuthInstitutionExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            try
            {
                string result = apiInstance.AuthInstitution();
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling AuthorizationApi.AuthInstitution: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }

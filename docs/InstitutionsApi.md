...
------------- | ------------- | -------------
[**Create**](InstitutionsApi.md#create) | **POST** /v1/private/institutions | 
[**Fetch**](InstitutionsApi.md#fetch) | **GET** /v1/private/institutions/{institutionId} | 
[**FetchAll**](InstitutionsApi.md#fetchall) | **GET** /v1/private/institutions | 
[**Update**](InstitutionsApi.md#update) | **PUT** /v1/private/institutions/{institutionId} | 
...
namespace Example
{
    public class CreateExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new InstitutionsApi(Configuration.Default);
            ...
            {
                Debug.Print("Exception when calling InstitutionsApi.Create: " + e.Message );
...
namespace Example
{
    public class FetchExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling InstitutionsApi.Fetch: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class FetchAllExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling InstitutionsApi.FetchAll: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UpdateExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling InstitutionsApi.Update: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
